...
**** Conda.el
Use [[https://github.com/necaris/conda.el][=conda.el=]] to manage virtual environment and add conda support in =eshell= (check out this [[https://emacs.stackexchange.com/questions/61196/how-can-i-run-conda-in-emacs-shell][issue]]).
